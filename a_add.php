...
if (isset($_POST['tambah'])) {
  ...
  try {
    ...
    $stmt = $pdo->query("INSERT INTO soal (pertanyaan, pilihan_1, pilihan_2, pilihan_3, pilihan_4, kunci_jawaban) VALUES ('$pertanyaan', '$pilihan_1', '$pilihan_2', '$pilihan_3', '$pilihan_4', '$kunci_jawaban')");
...
<html lang="id">
  <head>
    ...
    <title>Tambah Soal - Insan Penjaga Al-Qur'an</title>
